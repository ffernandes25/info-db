...
public class GenerateDatabaseMetadataView extends JFrame {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1215, 637));
        setResizable(false);
        setSize(new java.awt.Dimension(1215, 637));
        ...
        panelDatabaseMetadata.setMaximumSize(new java.awt.Dimension(1200, 400));
        panelDatabaseMetadata.setMinimumSize(new java.awt.Dimension(1200, 400));
        panelDatabaseMetadata.setPreferredSize(new java.awt.Dimension(1200, 602));
        ...
        panelDatabaseMetadata.setBounds(0, 0, 1200, 602);
